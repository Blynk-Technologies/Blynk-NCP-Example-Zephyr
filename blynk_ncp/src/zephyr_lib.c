...
static const struct gpio_dt_spec staus_led =
        GPIO_DT_SPEC_GET(DT_CHOSEN(blynk_ncp_status_led), gpios);
#endif
...
{
    const uint32_t br[] = {
            38400,  115200, CONFIG_BLYNK_NCP_BAUD, 9600, 19200, 28800, 57600, 76800, 230400,
            460800, 921600};
    int i = 0;
...
static void ncpThread(void *, void *, void *)
{
    ...
    rpc_blynk_setFirmwareInfo(CONFIG_BLYNK_FIRMWARE_TYPE, CONFIG_BLYNK_FIRMWARE_VERSION,
                              BLYNK_FIRMWARE_BUILD_TIME, BLYNK_RPC_LIB_VERSION);
    ...
    rpc_hw_initRGB(CONFIG_BLYNK_NCP_ONBOARD_RGB_R_GPIO_NUM, CONFIG_BLYNK_NCP_ONBOARD_RGB_G_GPIO_NUM,
                   CONFIG_BLYNK_NCP_ONBOARD_RGB_B_GPIO_NUM, CONFIG_BLYNK_NCP_ONBOARD_LED_COM_ANODE);
    rpc_hw_setLedBrightness(CONFIG_BLYNK_NCP_ONBOARD_LED_BRIGHT);
#endif

#if defined(CONFIG_BLYNK_NCP_ONBOARD_LED)
    rpc_hw_initLED(CONFIG_BLYNK_NCP_ONBOARD_LED_GPIO_NUM, CONFIG_BLYNK_NCP_ONBOARD_LED_COM_ANODE);
    rpc_hw_setLedBrightness(CONFIG_BLYNK_NCP_ONBOARD_LED_BRIGHT);
#endif
